    ...
    def Step(self):
        ...
        for i in range(self.npart):
            if self.vpos[i] < self.gbest[-1]:
                ...
                img_name = "imageGA" + str(i) + ".png"
                new_img_name = "bestmodelimageGA" + str(self.bestcount) + ".png"
                os.rename(img_name, new_img_name)
                print("made" + new_img_name)
                img_name = "2imageGA" + str(i) + ".png"
                new_img_name = "2bestmodelimageGA" + str(self.bestcount) + ".png"
                os.rename(img_name, new_img_name)
                print("made" + new_img_name)
